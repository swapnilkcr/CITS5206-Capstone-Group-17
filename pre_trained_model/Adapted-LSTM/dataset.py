...
class WindowDataset(Dataset):
    ...
    def __getitem__(self, idx):
        # torch is guaranteed to be available due to __init__ guard
...
def concat_by_time(parts: Iterable[SKABSeries]) -> SKABSeries:
    ...
    return SKABSeries(x=x, y=y, t=t, feature_cols=list(feature_cols), label_col=label_col, time_col=time_col)
...
def make_window_dataset(
    ...
    *,
    ...
    # WindowDataset expects indexable sequences; we keep python lists here.
